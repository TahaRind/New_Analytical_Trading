...
except Exception:  # matplotlib is optional for non-plot workflows
    plt = None
    mdates = None
    gridspec = None
...
class StockAnalyser():
    ...
    def create_plot(self,start,end,ms,*graphs):
      if plt is None or gridspec is None:
          raise RuntimeError("matplotlib is required for create_plot(). Install matplotlib to use this feature.")
